...
namespace TenmoServer.DAO
{
    public class UserSqlDao : IUserDao
    {
        ...
        //public List<TransferUser> GetUsersForTransfer()
        //{
        //    List<TransferUser> transferUsers = new List<TransferUser>();
        ...
        //            SqlCommand cmd = new SqlCommand("SELECT account_id, username FROM users join accounts on users.user_id = accounts.user_id", conn);
        //            SqlDataReader reader = cmd.ExecuteReader();

        //            while (reader.Read())
        //            {
        //                TransferUser u = GetTransferFromReader(reader);
        //                transferUsers.Add(u);
        //            }
        //        }
        //    }
        ...
        //private TransferUser GetTransferFromReader(SqlDataReader reader)
        //{
        //    TransferUser u = new TransferUser()
        //    {
